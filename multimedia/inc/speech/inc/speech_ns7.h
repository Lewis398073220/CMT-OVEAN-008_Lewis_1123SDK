...
int32_t speech_ns7_in_2mic_process(SpeechNs7State *st, float *mag, uint32_t pcm_len);
SpeechNs7State* speech_ns7_in_2mic_create(uint32_t sample_rate, uint32_t frame_size);
