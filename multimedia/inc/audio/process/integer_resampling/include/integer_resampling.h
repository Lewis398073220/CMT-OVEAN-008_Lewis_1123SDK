...
typedef enum  {
    INTEGER_RESAMPLING_ITEM_32K_TO_16K = 0,
...
// Call this function before integer_resampling_create
int32_t integer_resampling_init(void *get_ext_buff(size_t, size_t), void free_buff(void *));

// Creat a instance from integer_resampling module/class
IntegerResamplingState *integer_resampling_create(int32_t frame_size, int32_t channel_num, INTEGER_RESAMPLING_ITEM_T item);
