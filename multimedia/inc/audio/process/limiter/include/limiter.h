...
LimiterState *limiter_create(int32_t sample_rate, int32_t sample_bit, int32_t channel_number, const LimiterConfig *config);

LimiterState *limiter_create_with_custom_allocator(int32_t sample_rate, int32_t sample_bit, int32_t channel_number, const LimiterConfig *config, custom_allocator *allocator);
