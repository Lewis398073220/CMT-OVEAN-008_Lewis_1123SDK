...
arm_status arm_fully_connected_q7_bes_q31(const q7_t *pV,
                                  const q7_t *pM,
                                  const uint16_t dim_vec,
                                  const uint16_t num_of_rows,
                                  q31_t *pOut,
...
arm_status arm_fully_connected_q15_q15_q31_out_q63(const q15_t* pV,
                                  const q15_t* pM,
                                  const uint16_t dim_vec,
                                  const uint16_t num_of_rows,
                                  const uint16_t bias_shift,
...
arm_status arm_fully_connected_q15_q7_q31_q31(const q15_t* pV,
                                  const q7_t* pM,
                                  const uint16_t dim_vec,
                                  const uint16_t num_of_rows,
                                  const uint16_t out_shift,
...
arm_status arm_convolve_1x1_HWC_q15_q7_q31(const q15_t *Im_in,
                                  const uint16_t dim_im_in_x,
                                  const uint16_t dim_im_in_y,
                                  const uint16_t ch_im_in,
                                  const q7_t *wt,
...
arm_status arm_fully_connected_q15_q7_q31(const q15_t *pV,
                                  const q7_t *pM,
                                  const uint16_t dim_vec,
                                  const uint16_t num_of_rows,
                                  const uint16_t out_shift,
