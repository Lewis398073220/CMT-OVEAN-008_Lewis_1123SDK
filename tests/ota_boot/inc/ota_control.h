...
#ifdef OTA_LOG_DEBUG
#define LOG_DBG(num,str,...)   TRACE(num,"DBG:""" str, ##__VA_ARGS__)             // DEBUG OUTPUT
#define LOG_MSG(num,str,...)   TRACE(num,"MSG:""" str, ##__VA_ARGS__)             // MESSAGE OUTPUT
#define LOG_ERR(num,str,...)   TRACE(num,"ERR:""" str, ##__VA_ARGS__)             // ERROR OUTPUT

#define LOG_FUNC_LINE()    TRACE(2,"%s:%d\n", __FUNCTION__, __LINE__)
#define LOG_FUNC_IN()      TRACE(1,"%s ++++\n", __FUNCTION__)
#define LOG_FUNC_OUT()     TRACE(1,"%s ----\n", __FUNCTION__)

#define LOG_DUMP		   DUMP8
#else
#define LOG_DBG(str,...)
#define LOG_MSG(num,str,...)   TRACE(num,"" str, ##__VA_ARGS__)
#define LOG_ERR(num,str,...)   TRACE(num,"ERR:""" str, ##__VA_ARGS__)
...
#ifndef OTA_FLASH1_LOGIC_ADDR
#define OTA_FLASH1_LOGIC_ADDR       (FLASH1_NC_BASE)
#endif
#endif
...
uint32_t  app_get_new_image_offset(void);
void app_update_magic_number(uint32_t newMagicNumber);
