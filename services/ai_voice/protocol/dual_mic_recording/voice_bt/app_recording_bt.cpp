 ...
 * SPP SDP record.
 */
static bt_sdp_record_attr_t VOICE_SPP_SdpAttributes1[] = { // list attr id in ascending order
...
void VOICE_SPP_RegisterSdpServices(uint8_t *service_id, bt_sdp_record_param_t *param)
{
    /* Register 128bit UUID SDP Attributes */
    *service_id = RFCOMM_CHANNEL_COMMON_RECORD;

    param->attrs = (bt_sdp_record_attr_t *)(&VOICE_SPP_SdpAttributes1[0]);
 ...
 * SPP SDP record.
 */
static bt_sdp_record_attr_t VOICE_SPP_128UuidSdpAttributes[] = { // list attr id in ascending order
...
void VOICE_SPP_Register128UuidSdpServices(uint8_t *service_id, bt_sdp_record_param_t *param)
{
    /* Register 128bit UUID SDP Attributes */
    *service_id = RFCOMM_CHANNEL_COMMON_RECORD;

    param->attrs = (bt_sdp_record_attr_t *)(&VOICE_SPP_128UuidSdpAttributes[0]);
