...
void app_ibrt_ble_adv_para_data_init(void)
{
    ...
    adv_para_cfg->adv_type = BES_ADV_CONN_UNDIR;
    ...
    adv_para_cfg->adv_chanmap = BES_ADV_ALL_CHNLS_EN;
    adv_para_cfg->adv_filter_policy = BES_ADV_ALLOW_SCAN_ANY_CON_ANY;
...
void app_ibrt_ble_switch_activities(void)
{
    ...
    {
        case BLE_START_ADV:
             app_ibrt_ble_adv_start(BES_ADV_CONN_UNDIR, app_ble_adv_para_data_cfg.advInterval_Ms);
             break;
        default:
             break;
    }
