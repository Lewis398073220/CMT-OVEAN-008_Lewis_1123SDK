 ...
 ****************************************************************************************
 *
 * @file app_display_prf.c
 *
 * @brief Application Display Profile entry point
 *
 ...
 ****************************************************************************************
 */
static void app_display_hdl_adv(uint8_t input);
#if (BLE_APP_HT)
static void app_display_hdl_ht_temp_type(uint8_t input);
static void app_display_hdl_ht_temp_value(uint8_t input);
#endif //BLE_APP_HT
...
static void app_display_hdl_adv(uint8_t input)
{
    switch(input)
    {
        ...
        {
            app_update_adv_state(!app_display_env.advertising);
        }
        break;
        default:
        break;
 ...
 ****************************************************************************************
 */
static void app_display_hdl_bond(uint8_t input)
{
    switch(input)
    {
        case DISPLAY_INPUT_SELECT:
 ...
 ****************************************************************************************
 */
void app_display_prf_init(void)
{
        /* ***********************************************************************/
        /*                              Screen Allocation                        */
        /* ***********************************************************************/
