...
typedef void (*app_dis_get_data_cb)(uint8_t req_type, app_dis_get_data *get_data);
...
/**
 ****************************************************************************************
 * @brief Register to get the dis service parameter callback from the user layer
 ****************************************************************************************
 */
