 ...
 ****************************************************************************************
 */
typedef void    (*prf_con_upd_cb) (prf_data_t* p_env, uint8_t conidx, const gap_le_con_param_t* p_con_param);
...
/**
 ****************************************************************************************
 * @brief Check 128-bit service validity
 *
 * @param nb_chars     Number of Characteristics in the service
 * @param p_chars      Characteristics values (char handles, val handles, properties)
 * @param p_chars_req  Characteristics requirements.
 * @param nb_descs     Number of Description Characteristics in the service
 * @param p_descs      Description Characteristics values (char handles, val handles, properties)
 * @param p_descs_req  Description Characteristics requirements.
 *
 * @return Execution status (see enum #hl_err)
 ****************************************************************************************
 */
uint16_t prf_check_svc128_validity(uint8_t nb_chars, const prf_char_t* p_chars, const prf_char128_def_t* p_chars_req,
                                uint8_t nb_descs, const prf_desc_t* p_descs, const prf_desc_def_t* p_descs_req);
