 ...
 ****************************************************************************************
 */
typedef void (*bap_bc_src_cb_info)(uint8_t grp_lid, const iap_bg_config_t* p_bg_cfg, uint8_t nb_bis,
 ...
 ****************************************************************************************
 */
uint16_t bap_bc_src_add_group(const bap_bcast_id_t* p_bcast_id, uint8_t nb_streams, uint8_t nb_subgroups,
                              const bap_bc_grp_param_t* p_grp_param, const bap_bc_adv_param_t* p_adv_param,
                              const bap_bc_per_adv_param_t* p_per_adv_param, uint32_t pres_delay_us,
                              uint8_t* p_grp_lid);
 ...
 *
 * @return An error status (see #gaf_err enumeration)
 * If no error, no new function should be executed until @see bap_bc_src_cb_cmp_evt callback function with
 ...
 *
 * @return An error status (see #gaf_err enumeration).
 *         If no error, no new function should be executed from the Group until @see bap_bc_src_cb_cmp_evt callback
