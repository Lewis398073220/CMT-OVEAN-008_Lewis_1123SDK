 ...
 ****************************************************************************************
 */
typedef void (*arc_aics_cb_description_req)(uint8_t input_lid, uint8_t con_lid, uint8_t desc_len, uint8_t* p_desc);
 ...
 ****************************************************************************************
 */
void arc_aics_set_description_cfm(uint16_t cfm_status, uint8_t input_lid, uint8_t desc_len, const uint8_t *p_desc);
