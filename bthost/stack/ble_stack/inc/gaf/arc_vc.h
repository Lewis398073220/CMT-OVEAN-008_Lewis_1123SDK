...
#define ARC_VC_UPDATE_VOL   (1)
#define ARC_VC_UPDATE_MUTE  (2)
#define ARC_VC_UPDATE_VOL_MUTE  (ARC_VC_UPDATE_VOL | ARC_VC_UPDATE_MUTE)
#endif
/// @} ARC_VC_DEF
...
#ifdef BLE_STACK_PORTING_CHANGES
/// List of changed reason value for Volume Control Service
enum arc_vc_changed_reason
{
    /// Local change
    ARC_VC_CHANGED_LOCAL = 0,
    /// Remote change
    ARC_VC_CHANGED_REMOTE,
    /// TWS sync change
    ARC_VC_CHANGED_TWS,
    /// not define
    ARC_VC_CHANGED_UNKNOW = 0xFF,
};
#endif
/// @} ARC_VC_ENUM
