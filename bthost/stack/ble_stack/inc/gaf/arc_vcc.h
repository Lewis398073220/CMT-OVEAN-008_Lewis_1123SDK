...
enum arc_vcc_cmd_type
{
    ...
    /// Get Configuration
    ARC_VCC_CMD_TYPE_GET_CFG,
    /// Set Configuration
    ARC_VCC_CMD_TYPE_SET_CFG,
};
...
typedef void (*arc_vcc_cb_volume)(uint8_t con_lid, uint8_t volume, uint8_t mute, uint8_t change_cnt);
#else
 ...
 ****************************************************************************************
 */
#define arc_vcc_volume_increase(con_lid) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_UP, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcc_volume_decrease(con_lid) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_DOWN, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcc_volume_set(con_lid, volume) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_SET_ABS, volume)
 ...
 ****************************************************************************************
 */
#define arc_vcc_mute(con_lid) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_MUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcc_unmute(con_lid) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_UNMUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcc_volume_increase_unmute(con_lid) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_UP_UNMUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcc_volume_decrease_unmute(con_lid) arc_vcc_control(con_lid, ARC_VC_OPCODE_VOL_DOWN_UNMUTE, 0)
