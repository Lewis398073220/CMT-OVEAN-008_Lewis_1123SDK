 ...
 ****************************************************************************************
 */
void acc_mcs_cfm_control(uint16_t status, uint8_t media_lid, uint8_t result,
 ...
 ****************************************************************************************
 */
void acc_mcs_cfm_search(uint16_t status, uint8_t media_lid, const acc_mc_object_id_t* p_obj_id);
#endif //(GAF_ACC_OTS)
