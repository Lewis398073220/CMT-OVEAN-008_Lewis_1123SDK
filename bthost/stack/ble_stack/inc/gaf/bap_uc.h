...
enum bap_uc_cp_reason
{
    ...
    /// APP layer rejected
    BAP_UC_CP_REASON_APP_REJECTED,
    /// OPCODE not match
    BAP_UC_CP_REASON_OPCODE_NOT_MATCH,
    /// Parameter check failed
    BAP_UC_CP_REASON_PARAM_ERR,
    /// ASE lid not match
    BAP_UC_CP_REASON_ASE_LID_NOT_MATCH,
    /// ASE lid invalid
    BAP_UC_CP_REASON_ASE_LID_INTVALID,
    /// Additional info error
    BAP_UC_CP_REASON_ADD_INFO_ERR,
    /// ASE ENV invalid
    BAP_UC_CP_REASON_ASE_ENV_INVALID,
