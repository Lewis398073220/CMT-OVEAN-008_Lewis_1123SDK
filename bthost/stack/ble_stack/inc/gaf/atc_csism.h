 ...
 ****************************************************************************************
 */
#define atc_csism_add(cfg_bf, size, rank, lock_timeout_s, shdl, p_sirk) \
                                        (csism_add(cfg_bf, size, rank, lock_timeout_s, shdl, p_sirk))
 ...
 ****************************************************************************************
 */
#define atc_csism_restore_bond_data(con_lid, set_lid, is_locked, cli_cfg_bf, evt_cfg_bf) \
                                        (csism_restore_bond_data(con_lid, set_lid, is_locked, cli_cfg_bf, evt_cfg_bf))
 ...
 ****************************************************************************************
 */
#define atc_csism_set_size(set_lid, size) \
                                        (csism_set_size(set_lid, size))
 ...
 ****************************************************************************************
 */
#define atc_csism_ltk_cfm(p_ltk)        (csism_ltk_cfm(p_ltk))
 ...
 ****************************************************************************************
 */
#define atc_csism_is_proc_allowed(con_lid, set_lid) \
                                        (csism_is_proc_allowed(con_lid, set_lid))
