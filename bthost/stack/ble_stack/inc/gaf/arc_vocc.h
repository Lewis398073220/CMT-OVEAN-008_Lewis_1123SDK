...
enum arc_vocc_cmd_type
{
    ...
    /// Get Configuration
    ARC_VOCC_CMD_TYPE_GET_CFG,
    /// Set Configuration
    ARC_VOCC_CMD_TYPE_SET_CFG,
};
 ...
 ****************************************************************************************
 */
#define arc_vocc_set_offset(con_lid, output_lid, offset) arc_vocc_set(con_lid, output_lid,              \
                                                                      ARC_VOC_SET_TYPE_OFFSET, offset);
 ...
 ****************************************************************************************
 */
#define arc_vocc_set_location(con_lid, output_lid, location) arc_vocc_set(con_lid, output_lid,          \
                                                                          ARC_VOC_SET_TYPE_LOCATION, location);
