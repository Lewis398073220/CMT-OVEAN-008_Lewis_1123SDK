...
enum bap_capa_cli_msg_cmd_code
{
    ...
    /// Get Configuration (see #bap_capa_cli_get_cfg_cmd_t)
...
enum bap_capa_cli_msg_ind_code
{
    ...
    /// Configuration (see #bap_capa_cli_cfg_ind_t)
...
{
    /// Command code (shall be set to #BAP_CAPA_CLI_GET_CFG)
    uint16_t cmd_code;
    /// Connection local index
    uint8_t con_lid;
    /// Characteristic type (see #bap_capa_char_type enumeration)
...
{
    /// Indication code (shall be set to #BAP_CAPA_CLI_CFG)
    uint16_t ind_code;
    /// Connection local index
    uint8_t con_lid;
    /// Characteristic type (see #bap_capa_char_type enumeration)
