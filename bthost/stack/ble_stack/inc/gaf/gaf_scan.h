 ...
 ****************************************************************************************
 */
typedef void (*gaf_scan_cb_report)(const gap_bdaddr_t* p_addr, uint8_t info_bf, uint8_t flags, uint16_t appearance,
                                   const atc_csis_rsi_t* p_rsi, uint16_t length, const uint8_t* p_data);
 ...
 *
 * @param[in] p_addr        Pointer to Advertiser address
 * @param[in] type          Announcement type (see #gaf_announcement_type enumeration)
 * @param[in] context_bf    Context bit field
 * @param[in] p_metadata    Pointer to Metadata structure
 ****************************************************************************************
 */
typedef void (*gaf_scan_cb_announcement)(const gap_bdaddr_t* p_addr, uint8_t type, uint32_t context_bf,
