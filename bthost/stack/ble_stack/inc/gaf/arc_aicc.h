...
enum arc_aicc_cmd_type
{
    ...
    /// Get Configuration
    ARC_AICC_CMD_TYPE_GET_CFG,
    /// Set Configuration
    ARC_AICC_CMD_TYPE_SET_CFG,
};
 ...
 ****************************************************************************************
 */
#define arc_aicc_set_gain(con_lid, input_lid, gain) arc_aicc_control(con_lid, input_lid,                \
                                                                     ARC_AIC_OPCODE_SET_GAIN, gain)
 ...
 ****************************************************************************************
 */
#define arc_aicc_mute(con_lid, input_lid) arc_aicc_control(con_lid, input_lid, ARC_AIC_OPCODE_MUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_aicc_unmute(con_lid, input_lid) arc_aicc_control(con_lid, input_lid, ARC_AIC_OPCODE_UNMUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_aicc_set_manual_mode(con_lid, input_lid) arc_aicc_control(con_lid, input_lid,               \
                                                                      ARC_AIC_OPCODE_SET_MANUAL_MODE, 0)
 ...
 ****************************************************************************************
 */
#define arc_aicc_set_auto_mode(con_lid, input_lid) arc_aicc_control(con_lid, input_lid,               \
                                                                    ARC_AIC_OPCODE_SET_AUTO_MODE, 0)
