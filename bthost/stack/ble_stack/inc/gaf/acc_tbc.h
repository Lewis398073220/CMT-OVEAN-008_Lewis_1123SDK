...
enum acc_tbc_cmd_type
{
    ...
    /// Get Configuration
    ACC_TBC_CMD_TYPE_GET_CFG,
    /// Set Report Interval
    ACC_TBC_CMD_TYPE_SET_REPORT_INTV,
...
typedef void (*acc_tbc_cb_value_long)(uint8_t con_lid, uint8_t bearer_lid, uint8_t call_id,
                                      uint8_t char_type, uint16_t val_len, const uint8_t* p_val);
 ...
 ****************************************************************************************
 */
typedef void (*acc_tbc_cb_bond_data)(uint8_t con_lid, uint8_t bearer_lid,
 ...
 ****************************************************************************************
 */
uint16_t acc_tbc_discover(uint8_t con_lid, uint8_t nb_tbs_max, uint16_t shdl, uint16_t ehdl);
