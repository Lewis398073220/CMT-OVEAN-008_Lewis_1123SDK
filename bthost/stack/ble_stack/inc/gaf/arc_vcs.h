...
typedef void (*arc_vcs_cb_bond_data)(uint8_t con_lid, uint8_t char_type, uint8_t cli_cfg_bf);
#else
 ...
 * @param[in] change_cnt    Change Counter
 * @param[in] mute          Mute value
 ****************************************************************************************
 */
#ifdef BLE_STACK_PORTING_CHANGES
typedef void (*arc_vcs_cb_volume)(uint8_t volume, uint8_t mute, uint8_t change_cnt, uint8_t reason);
#else
 ...
 ****************************************************************************************
 */
uint16_t arc_vcs_control(uint8_t opcode, uint8_t volume,  bool no_changed_cb);

#ifdef BLE_STACK_PORTING_CHANGES
/**
 ****************************************************************************************
 * @brief Update local env info
 *
 * @return Result
 ****************************************************************************************
 */
uint16_t arc_vcs_update_local_info(uint8_t update_bit, uint8_t volume, uint8_t mute);
 ...
 ****************************************************************************************
 */
uint16_t arc_vcs_send_ntf_handler(uint8_t con_lid, uint8_t char_type);
#endif
 ...
 ****************************************************************************************
 */
#define arc_vcs_volume_increase() arc_vcs_control(ARC_VC_OPCODE_VOL_UP, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcs_volume_decrease() arc_vcs_control(ARC_VC_OPCODE_VOL_DOWN, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcs_volume_set(volume) arc_vcs_control(ARC_VC_OPCODE_VOL_SET_ABS, volume)
 ...
 ****************************************************************************************
 */
#define arc_vcs_mute() arc_vcs_control(ARC_VC_OPCODE_VOL_MUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcs_unmute() arc_vcs_control(ARC_VC_OPCODE_VOL_UNMUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcs_volume_increase_unmute() arc_vcs_control(ARC_VC_OPCODE_VOL_UP_UNMUTE, 0)
 ...
 ****************************************************************************************
 */
#define arc_vcs_volume_decrease_unmute() arc_vcs_control(ARC_VC_OPCODE_VOL_DOWN_UNMUTE, 0)
