 ...
 ****************************************************************************************
 */
typedef void (*arc_vocs_cb_description_req)(uint8_t output_lid, uint8_t con_lid, uint8_t desc_len, uint8_t* p_desc);
 ...
 ****************************************************************************************
 */
void arc_vocs_set_description_cfm(uint16_t cfm_status, uint8_t output_lid, uint8_t desc_len, const uint8_t *p_desc);
 ...
 ****************************************************************************************
 */
void arc_vocs_set_location_cfm(uint16_t cfm_status, uint8_t output_lid, uint32_t location_bf);
