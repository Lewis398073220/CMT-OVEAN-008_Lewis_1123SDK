...
/**
 ****************************************************************************************
 * @brief Callback function called when Characteristic Configuration descriptor has been
 * written by a client device
 *
 * @param[in] con_lid           Connection local index
 ****************************************************************************************
 */
typedef void (*bap_capa_srv_cb_cccd_written)(uint8_t con_lid);
...
typedef struct bap_capa_srv_cb
{
    ...
    /// written by a client device
    bap_capa_srv_cb_cccd_written cb_cccd_written;
} bap_capa_srv_cb_t;
