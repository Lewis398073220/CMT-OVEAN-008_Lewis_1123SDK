...
enum arc_micc_cmd_type
{
    ...
    /// Get Configuration
    ARC_MICC_CMD_TYPE_GET_CFG,
    /// Set Configuration
    ARC_MICC_CMD_TYPE_SET_CFG,
};
 ...
 ****************************************************************************************
 */
#define arc_micc_mute(con_lid) arc_micc_set_mute(con_lid, ARC_MIC_MUTE_MUTED)
 ...
 ****************************************************************************************
 */
#define arc_micc_unmute(con_lid) arc_micc_set_mute(con_lid, ARC_MIC_MUTE_NOT_MUTED)
