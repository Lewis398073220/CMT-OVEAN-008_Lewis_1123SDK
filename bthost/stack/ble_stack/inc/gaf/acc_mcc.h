...
enum acc_mcc_cmd_type
{
    ...
    /// Get Configuration
    ACC_MCC_CMD_TYPE_GET_CFG,
    /// Set Configuration
    ACC_MCC_CMD_TYPE_SET_CFG,
    /// Set
...
typedef void (*acc_mcc_cb_value_long)(uint8_t con_lid, uint8_t media_lid, uint8_t char_type,
                                      uint16_t val_len, const uint8_t* p_val);
 ...
 ****************************************************************************************
 */
#define acc_mcc_set_track_position(con_lid, media_lid, reliable, track_position)                \
            acc_mcc_set(con_lid, media_lid, ACC_MC_CHAR_TYPE_TRACK_POSITION, reliable, track_position)
 ...
 ****************************************************************************************
 */
#define acc_mcc_set_playback_speed(con_lid, media_lid, reliable, playback_speed)                \
            acc_mcc_set(con_lid, media_lid, ACC_MC_CHAR_TYPE_PLAYBACK_SPEED, reliable, playback_speed)
 ...
 ****************************************************************************************
 */
#define acc_mcc_set_playing_order(con_lid, media_lid, reliable, playing_order)                  \
            acc_mcc_set(con_lid, media_lid, ACC_MC_CHAR_TYPE_PLAYING_ORDER, reliable, playing_order)
 ...
 ****************************************************************************************
 */
#define acc_mcc_play(con_lid, media_lid, reliable)                                              \
        acc_mcc_control(con_lid, media_lid, ACC_MC_OPCODE_PLAY, reliable, 0)
 ...
 ****************************************************************************************
 */
#define acc_mcc_pause(con_lid, media_lid, reliable)                                             \
        acc_mcc_control(con_lid, media_lid, ACC_MC_OPCODE_PAUSE, reliable, 0)
 ...
 ****************************************************************************************
 */
#define acc_mcc_stop(con_lid, media_lid, reliable)                                              \
        acc_mcc_control(con_lid, media_lid, ACC_MC_OPCODE_STOP, reliable, 0)
