...
typedef void (*bap_bc_sink_cb_status)(uint8_t grp_lid, uint8_t state, uint32_t stream_pos_bf,
                                      const iap_bg_sync_config_t* p_bg_cfg, uint8_t nb_bis, const uint16_t* p_conhdl);
 ...
 * @param[in] dp_id             Data Path identifier
 ...
 ****************************************************************************************
 */
void bap_bc_sink_enable_cfm(uint8_t grp_lid, bool accept, uint16_t timeout_10ms, uint8_t mse);
