...
enum TASK_API_ID
{
    ...
    TASK_ID_SMART        = 76,   // SMART Task

    TASK_ID_DMA          = 77,   // DMA Task

    TASK_ID_TENCENT      = 78,   // TENCENT Task

    TASK_ID_GMA          = 79,   // GMA Task

    TASK_ID_CUSTOMIZE    = 80,   // CUSTOMIZE Task

    TASK_ID_BUDS         = 81,

    TASK_ID_GFPSP        = 82,   //google fast pair service provider
    TASK_ID_GFPSS        = 83,   // seeker

    TASK_ID_VOICEPATH    = 84,   // Voice Path Task

    TASK_ID_OTA          = 85,   // OTA Task

    TASK_ID_ANCC         = 86,   // ANCS Client Task

    TASK_ID_AMSC         = 87,   // AMS Client Task

    TASK_ID_BMS          = 88,   // BMS Task

    TASK_ID_ANCSP        = 89,   // ANCS Proxy Task

    TASK_ID_AMSP         = 90,   // AMS Proxy Task

    TASK_ID_DATAPATHPS   = 91,   // Datapath Server Task

    TASK_ID_AI           = 92,   // ai Task

    TASK_ID_TOTA         = 93,   // TOTA Task

    TASK_ID_TILE         = 94,   // skull tile task

    TASK_ID_SAS          = 95,   // SAS Task

    TASK_ID_SASC         = 96,   // SASC Task

    TASK_ID_AHPS         = 97,   // AHP server

    TASK_ID_DATAPATHPC   = 98,   // Datapath client Task
