...
#include "gatt.h"
#include "co_list.h"
#include "l2cap_att.h"   // Attribute L2CAP Protocol
#include "gap_hl_api.h"  // Simple Timer and Defer
 ...
 * @param[in] proc_state Procedure transition state (see enum #gatt_proc_state)
 ...
 ****************************************************************************************
 */
gatt_proc_t* gatt_proc_find(uint8_t conidx, uint16_t dummy, uint8_t user_lid);
