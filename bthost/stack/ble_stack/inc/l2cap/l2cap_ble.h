...
/**
 ****************************************************************************************
 * @addtogroup L2CAP_API Logical Link Control and Adaptation Protocol (L2CAP)
...
/**
 ****************************************************************************************
 * @addtogroup L2CAP_NATIVE_API Native API
 * @ingroup L2CAP_API
...
/// Invalid L2CAP channel local index L2CAP_SPSM_RESERVED
#define L2CAP_INVALID_SPSM (0xFF)
...
typedef struct l2cap_chan_coc_cb
{
     ...
     * @param[in] rx_mtu       Reception Maximum Transmit Unit Size
     * @param[in] tx_mtu       Transmission Maximum Transmit Unit Size
     * @param[in] rx_mps       Reception Maximum Packet Size
     * @param[in] tx_mps       Transmission Maximum Packet Size
     ****************************************************************************************
     */
    void (*cb_coc_created) (uint8_t conidx, uint16_t dummy, uint8_t chan_lid, uint16_t spsm, uint16_t rx_mtu, uint16_t tx_mtu, uint16_t rx_mps, uint16_t tx_mps);
...
typedef struct l2cap_coc_spsm_cb
{
     ...
     ****************************************************************************************
     */
    bool (*cb_coc_connect_req) (uint8_t conidx, uint16_t token, uint8_t nb_chan, uint16_t spsm, uint16_t peer_rx_mtu);
} l2cap_coc_spsm_cb_t;
...
void l2cap_ble_free_acl_rx_buffer(l2cap_acl_rx_t *p_acl_rx);
 ...
 * @param[in] local_rx_mtu  Local reception Maximum Transmit Unit Size
 * @param[in] initial_rx_credits RX credits count
 * @param[in] p_cb          Pointer to set of callback functions to be used for
 *                          communication with the Upper Layer.
 *
 * @return Status of the function execution (see enum #hl_err)
...
uint16_t l2cap_coc_connect_cfm(uint8_t conidx, uint16_t token, uint8_t nb_chan, uint16_t local_rx_mtu,
                              uint16_t initial_rx_credits, const l2cap_chan_coc_cb_t* p_cb);
