...
#if (mHDT_LE_SUPPORT)
enum hl_tci_mhdt_le_evt_handler_lid
{
    HL_TCI_MHDT_LE_RD_LOC_PROPRIETARY_FEAT_CMP_EVT,
    HL_TCI_MHDT_LE_RD_RM_PROPRIETARY_FEAT_CMP_EVT,

    HL_TCI_MHDT_LE_EVT_HANDLER_NB,
};
#endif
...
enum hl_hci_unsuported_handler_lid
{
    ...
    HL_HCI_LE_SUBRATE_CHANGE_EVT                       = HL_HCI_INVALID_LID,
