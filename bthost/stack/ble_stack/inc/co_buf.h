...
uint8_t co_buf_alloc_generic(co_buf_t** pp_buf, uint16_t head_len, uint16_t data_len, uint16_t tail_len, const char* func,const uint32_t line);
#define co_buf_alloc(pp_buf, head_len, data_len, tail_len)  co_buf_alloc_generic(pp_buf, head_len, data_len, tail_len, __func__, __LINE__)
#else
 ...
 ****************************************************************************************
 */
void co_buf_init(uint8_t init_type, uint32_t* p_big_pool, uint32_t *p_n4_pool, uint32_t* p_n3_pool, \
                    uint32_t* p_n2_pool, uint32_t* p_n1_pool, uint32_t* p_small_pool);
