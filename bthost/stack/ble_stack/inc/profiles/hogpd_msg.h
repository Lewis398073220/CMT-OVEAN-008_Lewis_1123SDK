...
enum hogpd_cfg_bf
{
    ...
    HOGPD_CFG_KEYBOARD_BIT          = CO_BIT(HOGPD_CFG_KEYBOARD_POS),

    /// Mouse Device
    HOGPD_CFG_MOUSE_POS             = 1,
    HOGPD_CFG_MOUSE_BIT             = CO_BIT(HOGPD_CFG_MOUSE_POS),

    /// Protocol Mode present
    HOGPD_CFG_PROTO_MODE_POS        = 2,
    HOGPD_CFG_PROTO_MODE_BIT        = CO_BIT(HOGPD_CFG_PROTO_MODE_POS),

    /// Extended Reference Present
    HOGPD_CFG_MAP_EXT_REF_POS       = 3,
    HOGPD_CFG_MAP_EXT_REF_BIT       = CO_BIT(HOGPD_CFG_MAP_EXT_REF_POS),

    /// Boot Keyboard Report write capability
    HOGPD_CFG_BOOT_KB_WR_POS        = 4,
    HOGPD_CFG_BOOT_KB_WR_BIT        = CO_BIT(HOGPD_CFG_BOOT_KB_WR_POS),

    /// Boot Mouse Report write capability
    HOGPD_CFG_BOOT_MOUSE_WR_POS     = 5,
    HOGPD_CFG_BOOT_MOUSE_WR_BIT     = CO_BIT(HOGPD_CFG_BOOT_MOUSE_WR_POS),
};
