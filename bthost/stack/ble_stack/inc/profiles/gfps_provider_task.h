...
enum
{
    ...
    GFPSP_LE_L2CAP_CONNECTED_IND,
    GFPSP_LE_L2CAP_DISCONNECTED_IND,   
    GFPSP_LE_L2CAP_RECEIVED_IND,

#ifdef SPOT_ENABLED
    GFPSP_BEACON_ACTIONS_NTF_CFG,
    GFPSP_BEACON_ACTIONS_WRITE_IND,
    GFPSP_BEACON_ACTIONS_WRITE_NOTIFY,
#endif
...
struct gfpsp_le_l2cap_recv_ind_t
{
    uint8_t     conidx;
    uint16_t    length;
    uint8_t     data[__ARRAY_EMPTY];
...
struct gfpsp_le_l2cap_conn_ind_t
{
    uint8_t     conidx;
    uint8_t     addr[6];
};

struct gfpsp_le_l2cap_disconn_ind_t
{
    uint8_t     conidx;
};
