...
#define HID_FEATURE_KEYBOARD                1
#define HID_FEATURE_MOUSE                   1
#define HID_FEATURE_MAP_EXT_REF             1
...
typedef struct hogpd_cb
{
     ...
     *
     * @note Request must be confirmed using # hogpd_proto_upd_cfm function.
     *
     * @param[in] conidx        Connection index
     ...
     *
     * @note Request must be confirmed using # hogpd_report_read_cfm function.
     *
     * @param[in] conidx        Connection index
     * @param[in] token         Token value that must be returned in confirmation
     * @param[in] hid_idx       HIDS Instance
     ...
     *
     * @note Request must be confirmed using # hogpd_report_write_cfm function.
     *
     * @param[in] conidx        Connection index
     * @param[in] token         Token value that must be returned in confirmation
     * @param[in] hid_idx       HIDS Instance
 ...
 ****************************************************************************************
 */
uint16_t hogpd_report_read_cfm(uint8_t conidx, uint16_t token, uint16_t status, uint16_t tot_length, co_buf_t* p_buf);
 ...
 *
 * Wait for #cb_report_upd_cmp execution before starting a new procedure
 *
 * @param[in] conidx        Connection index
 * @param[in] hid_idx       HIDS Instance
 * @param[in] report_idx    Report Instance - 0 for boot reports and report map
 ...
 ****************************************************************************************
 */
uint16_t hogpd_report_upd(uint8_t conidx, uint8_t hid_idx, uint8_t report_idx, uint8_t report_type, co_buf_t* p_buf);
/// @} HOGPD
/**
 ****************************************************************************************
 ...
 ****************************************************************************************
 */
//uint16_t hogpd_get_att_handle(hogpd_env_t* hogpd_env, uint8_t svc_idx, uint8_t att_idx, uint8_t report_idx);
 ...
 ****************************************************************************************
 */
//uint8_t hogpd_get_att_idx(hogpd_env_t* hogpd_env, uint16_t handle, uint8_t *svc_idx, uint8_t *att_idx, uint8_t *report_idx);
 ...
 ****************************************************************************************
 */
//uint8_t hogpd_ntf_send(uint8_t conidx, const struct hogp_report_info* report);
