...
/**
 ****************************************************************************************
 * @brief Callback function called when client configuration for a characteristic has been
 * received
 *
 * @param[in] con_lid           Connection local index
 * @param[in] set_lid           Coordinated Set local index
 * @param[in] char_type     Characteristic type
 * @param[in] enabled           Indicate if sending of notifications is enabled for the
 * indicated characteristic
 ****************************************************************************************
 */
typedef void (*csisc_cb_cfg)(uint8_t con_lid, uint8_t set_lid, uint8_t char_type, uint8_t enabled);
 ...
 *                          Characteristic type for CSISC_GET_CFG
...
typedef struct csisc_cb
{
    ...
    /// Callback function called when client configuration for a characteristic has been
    /// received
    csisc_cb_cfg cb_cfg;
 ...
 ****************************************************************************************
 */
uint16_t csisc_get_cfg(uint8_t con_lid, uint8_t set_lid, uint8_t char_type);
