...
/**
 ****************************************************************************************
 * @brief Callback function called when client configuration of a notification-capable
 * characteristic has been received
 *
 * @param[in] con_lid       Connection local index
 * @param[in] transfer_lid  Transfer local index
 * @param[in] char_type     Indication-capable characteristic type (see enum #otp_char_type)
 * @param[in] enabled       Indicate if sending of indications is enabled (!= 0)
 *                          for the indicated characteristic
 ****************************************************************************************
 */
typedef void (*otc_cb_cfg)(uint8_t con_lid, uint8_t transfer_lid, uint8_t char_type, uint8_t enabled);
...
typedef struct otc_cb
{
    ...
    /// Callback function called when client configuration of a notification-capable
    /// characteristic has been received
    otc_cb_cfg cb_cfg;
...
/**
 ****************************************************************************************
 * @brief Get current client configuration for one of the following characteristics
 ...
 * Client configuration for the indicated characteristic cannot be retrieved if
 * configuration for this characteristic is currently being set.
 *
 * @param[in] con_lid       Connection local index
 * @param[in] transfer_lid  Transfer local index
 * @param[in] char_type Indication-capable characteristic type (see enum #otp_char_type)
 ...
 ****************************************************************************************
 */
uint16_t otc_get_cfg(uint8_t con_lid, uint8_t transfer_lid, uint8_t char_type);
