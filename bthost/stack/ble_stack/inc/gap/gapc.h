...
/// Subrate Change Report information
typedef struct gapc_subrate_change_report
{
    /// Status
    uint8_t  status;
    /// subrate factor
...
/**
 ****************************************************************************************
 * @brief register debug info record callback when disconnect occurs.
 *
 ...
 ****************************************************************************************
 */
void gapc_dbg_ble_register_disconnect_info_record_cb(gapm_dbg_ble_dis_con_cmp_cb func);
#endif
/**
 ****************************************************************************************
 ...
 ****************************************************************************************
 */
const gap_bdaddr_t* gapc_peer_bdaddr_get(uint8_t conidx);
...
/**
 ****************************************************************************************
 * @brief Exchange mtu for a connection
 *
 * @param[in] conidx    Connection index
 *
 * @return Execution status (see enum #hl_err).
 ...
 ****************************************************************************************
 */
uint16_t gapc_exchange_mtu(uint8_t conidx);
