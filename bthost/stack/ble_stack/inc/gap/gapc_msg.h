...
enum gapc_msg_id
{
    ...
    /// Indicate that a BT Classic connection has been established
    GAPC_MTU_CHANGED_IND                                = MSG_ID(GAPC, 0x09),
    ...
    /// Command is used to exchange mtu for a connecton
    GAPC_EXCHANGE_MTU_CMD                               = MSG_ID(GAPC, 0x87),

    /* LE Subrate Control */
    /// Control Subrate
    GAPC_SUBRATE_CTRL_CMD                               = MSG_ID(GAPC, 0x88),
    /// Subrate Change Event Indication
    GAPC_SUBRATE_CHANGE_IND                             = MSG_ID(GAPC, 0x89),
};
/// @} GAPC_MSG_ID_API
...
enum gapc_operation
{
    ...
    /* LE Subrate*/
    /// command is set default subrate
    GAPC_SET_DEFAULT_SUBRATE                      = 0x90,
    /// command is subrate request
    GAPC_SUBRATE_REQUEST                          = 0X91,
};
/// @} GAPC_MSG_OPID_API
...
/// BT Classic excahnged IO Capabilities
/*@TRACE*/
