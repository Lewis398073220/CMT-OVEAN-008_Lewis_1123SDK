...
/*@TRACE*/
typedef struct gapm_dbg_iq_ctrl
{
    /// I-sample control
...
typedef struct gapm_test_tx_param
{
    ...
    int8_t  tx_pwr_lvl;
} gapm_test_tx_param_t;

/// RX Test Mode parameters
typedef struct gapm_test_rx_param
{
    /// Rx Channel (Range 0x00 to 0x27)
    uint8_t channel;
    /// Test PHY rate (see enum #gap_phy_val)
    uint8_t phy;
    /// Modulation Index (see enum #gap_modulation_idx)
    uint8_t modulation_idx;
    /// Slot durations
    uint8_t slot_dur;
} gapm_test_rx_param_t;

/// Test Mode CTE parameters
typedef struct gapm_test_cte_param
{
...
typedef struct gapm_test_rx_actv_cb
{
 ...
 ****************************************************************************************
 */
uint16_t gapm_test_rx_create(uint32_t dummy, const gapm_test_rx_actv_cb_t* p_cbs, uint8_t* p_actv_idx);
 ...
 ****************************************************************************************
 */
uint16_t gapm_test_rx_start(uint8_t actv_idx, const gapm_test_rx_param_t* p_param);
 ...
 ****************************************************************************************
 */
uint16_t gapm_test_rx_start_with_cte(uint8_t actv_idx, const gapm_test_rx_param_t* p_param,
                                     const gapm_test_cte_param_t* p_cte_param, const uint8_t* p_antenna_id);
 ...
 ****************************************************************************************
 */
uint16_t gapm_test_tx_create(uint32_t dummy, const gapm_actv_cb_t* p_cbs, uint8_t* p_actv_idx);
 ...
 ****************************************************************************************
 */
uint16_t gapm_test_tx_start(uint8_t actv_idx, const gapm_test_tx_param_t* p_param);
 ...
 ****************************************************************************************
 */
uint16_t gapm_test_tx_start_with_cte(uint8_t actv_idx, const gapm_test_tx_param_t* p_param,
                                     const gapm_test_cte_param_t* p_cte_param, const uint8_t* p_antenna_id);
