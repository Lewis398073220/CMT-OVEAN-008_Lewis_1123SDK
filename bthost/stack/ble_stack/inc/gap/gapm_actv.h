...
typedef void (*gapm_dbg_ble_con_cmp_info_record_cb)(uint8_t status, uint8_t conidx, uint8_t peer_addr_type,
    uint8_t *p_peer_addr, uint16_t con_interval, uint16_t con_latency, uint16_t sup_to);

void gapm_dbg_ble_register_con_info_record_cb(gapm_dbg_ble_con_cmp_info_record_cb func);
typedef void (*gapm_dbg_ble_dis_con_cmp_cb)(uint8_t con_idx, uint8_t reason);
void gapm_register_le_con_cmp_dbg_delete_con_info_cb(gapm_dbg_ble_dis_con_cmp_cb func);
#endif
