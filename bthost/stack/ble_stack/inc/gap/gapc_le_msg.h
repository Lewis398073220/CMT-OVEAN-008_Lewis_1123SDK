...
/// Set Default Subrate
/*@TRACE*/
typedef struct gapc_subrate_cmd
{
    /// Connection index
    uint8_t  conidx;
    /// GAP request type:
    /// - #GAPC_SET_DEFAULT_SUBRATE
    /// - #GAPC_SUBRATE_REQUEST
    uint8_t  operation;
    /// Subrate min
...
/*@TRACE*/
typedef struct gapc_subrate_change_ind
{
    /// Connection index
    uint8_t conidx;
    /// Status
