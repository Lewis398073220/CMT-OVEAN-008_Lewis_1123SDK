 ...
 ***************************************************************************************
 */
typedef void (*gapm_rand_addr_cb)(uint32_t dummy, uint16_t status, const gap_addr_t* p_addr);
...
/**
 ***************************************************************************************
 * @brief Set RPA Timeout
 *
 * @param[in] rpa_timeout     RPA Timeout
 *
 * @return Execution status (see enum #hl_err).
 ***************************************************************************************
 */
uint16_t gapm_set_rpa_timeout(uint32_t dummy, uint16_t rpa_timeout, gapm_proc_cmp_cb cmp_cb);
 ...
 *
 * Application should wait #gapm_rand_addr_cb callback execution before starting a new procedure
 *
 * @param[in] dummy             Dummy parameter provided by upper layer application.
 ...
 *
 * @return Execution status (see enum #hl_err).
 *         If returns GAP_ERR_NO_ERROR, upper layer SW shall wait for #gapm_rand_addr_cb callback execution
 ***************************************************************************************
 */
uint16_t gapm_get_ral_local_rpa(uint32_t dummy, const gap_bdaddr_t* p_peer_identity, gapm_rand_addr_cb res_cb);
 ...
 ***************************************************************************************
 */
uint16_t gapm_get_ral_peer_rpa(uint32_t dummy, const gap_bdaddr_t* p_peer_identity, gapm_rand_addr_cb res_cb);
 ...
 ***************************************************************************************
 */
uint16_t gapm_gen_rand_addr(uint32_t dummy, uint8_t rnd_type, gapm_rand_addr_cb res_cb);
