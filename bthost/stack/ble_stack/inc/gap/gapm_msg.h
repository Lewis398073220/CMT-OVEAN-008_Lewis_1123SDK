...
enum gapm_msg_id
{
    ...
    /* BT Classic Link key storage management */
    /// Store a link key in host
    GAPM_LINK_KEY_STORE_CMD             = MSG_ID(GAPM, 0x40),
    /// Remove one key from storage
    GAPM_LINK_KEY_REMOVE_CMD            = MSG_ID(GAPM, 0x41),
    /// Remove all key from storage
    GAPM_LINK_KEY_REMOVE_ALL_CMD        = MSG_ID(GAPM, 0x42),
    /// Read Link key present in storage
    GAPM_LINK_KEY_GET_CMD               = MSG_ID(GAPM, 0x43),
    /// Information about a link key
    GAPM_LINK_KEY_IND                   = MSG_ID(GAPM, 0x44),
    ...
    GAPM_LE_SET_RPA_TIMEOUT_CMD         = MSG_ID(GAPM, 0x57),
...
enum gapm_operation
{
    ...
    /* BT Classic Link key storage management */
    /// Store a link key in host
    GAPM_LINK_KEY_STORE                            = 0x40,
    /// Remove one key from storage
    GAPM_LINK_KEY_REMOVE                           = 0x41,
    /// Remove all key from storage
    GAPM_LINK_KEY_REMOVE_ALL                       = 0x42,
    /// Read Link key present in storage
    GAPM_LINK_KEY_GET                              = 0x43,
    ...
    /// Set resolving rivate paddress timeout
    GAPM_SET_RPA_TIMEOUT                           = 0x57,
