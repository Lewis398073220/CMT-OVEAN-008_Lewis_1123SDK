...
ThirdpartyAssistRes thirdparty_anc_assist_process(float **ff_mic, uint8_t ff_ch_num, float **fb_mic, uint8_t fb_ch_num, float **talk_mic, uint8_t talk_ch_num, float **ref, uint8_t ref_ch_num, uint32_t frame_len)
{
